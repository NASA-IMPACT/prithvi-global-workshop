...
class prithvi_wrapper(nn.Module):
    def __init__(self,n_channels, n_classes,n_frame,embed_size,input_size,patch_size,prithvi_weight,
                prithvi_config,in_chans,config):
        ...
        self.prithvi_backbone=LORA_peft(self.prithvi_backbone,Lora_peft_layer_name_pre,Lora_peft_layer_name_suffix,LP_layer_no_start,LP_layer_no_end)
