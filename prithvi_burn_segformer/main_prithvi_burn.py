...
def main():
    ...
    model=prithvi_wrapper(segmentor_config,n_channel,n_class,n_frame,embed_size,input_size,patch_size,config["prithvi_model_new_weight"],config["prithvi_model_new_config"]) #wrapper of prithvi #initialization of prithvi is done by initializing prithvi_loader.py
    ...
    optimizer = AdamW(model.parameters(), lr=6e-4, weight_decay=0.05)
